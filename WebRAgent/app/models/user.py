...
from app.services.local_store import get_client, LocalClient

# Хранилище пользователей: MongoDB, если доступен, иначе локальный JSON-файл
# (на Jetson нет Docker, поэтому Mongo обычно отсутствует).
client = get_client()
db = client[os.environ.get('MONGODB_DB', 'ragapp')]
